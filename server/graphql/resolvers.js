...
export const resolvers = {
    ...
    Mutation: {
        //When use "_" as a parameter is because it'll don't be use
        ...
        updateProject: async (_, args) => {
            const updatedProject = await Project.findByIdAndUpdate(args._id, args, {
                new: true, //return as a response the object updated
            });
    ...
    Task: {
        project: async (parent) => await Project.findById({ _id: parent.projectId })
    }
}